...
public class MyDBHandler extends SQLiteOpenHelper{
    ...
    public boolean settingProduct(String productname, String aftername){
        boolean result = false;
        int rowsUpdated;
        ContentValues values = new ContentValues();
        values.put(COLUMN_PRODUCTNAME, aftername);

        String selection = "productname = \""+productname+"\"";
        rowsUpdated = myCR.update(MyContentProvider.CONTENT_URI, values, selection,null);
